    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        <div class="bg-white p-6 shadow sm:rounded-lg flex">
            <div class="w-1/4">
                ...
                <img src="{{ $staff->profile_picture }}" alt="{{ $staff->name }}" class="w-50 h-50 object-cover rounded-md mb-4">
                @else
                <img src="{{ asset('storage/' . $staff->profile_picture) }}" alt="{{ $staff->name }}" class="w-50 h-50 object-cover rounded-md mb-4">
                @endif
                ...
                <ul class="mt-2">
                    ...
                    @empty
                    <p class="text-gray-600">No animeography available for this staff.</p>
                    @endforelse
                </ul>
            </div>
