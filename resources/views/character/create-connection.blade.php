    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        <div class="bg-white p-6 shadow sm:rounded-lg">
            <form action="{{ route('anime.characters.store', $anime) }}" method="post">
                ...
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 mb-4 rounded-md">Add Character</button>
            </form>
            <a href="{{ route('characters.create') }}" class="text-link-blue">
                <strong class="text-sm">Create New Character</strong>
            </a>
        </div>
    </div>
</x-app-layout>